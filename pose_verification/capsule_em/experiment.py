...
tf.app.flags.DEFINE_bool('train', False, 'train or test.')
tf.app.flags.DEFINE_integer(
...
tf.app.flags.DEFINE_integer('eval_size', 64,
...
tf.app.flags.DEFINE_bool('patching', False, 'If set use patching for eval.')
